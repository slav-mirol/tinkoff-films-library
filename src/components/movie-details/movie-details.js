    ...
    return (
        <div className='movie-details'>
            <div style={{display:'flex', flexDirection:'row', justifyContent:'space-between'}}>
                ...
                <button className='edit-btn' onClick={()=>{props.editMovie()}}>
            ...
            <div style={{display:'flex', flexDirection:'row', justifyContent:'start'}}>
                <img className='image' src={props.movie.posterUrl} alt='img of film'></img>
                <div className='info'>
                    <p className='title-of-film'>{props.movie.title}</p>
                    <p className='param' style={{marginTop:0}}>{props.movie.director}</p>
