    ...
    return (
      <div className="form" id="add-form">
        ...
        <div className="params">
          ...
          <input
            className="inp-param"
            placeholder="Введите режиссера фильма"
